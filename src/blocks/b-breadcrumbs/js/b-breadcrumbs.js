...
import '../scss/b-breadcrumbs.scss';
...
class Breadcrumbs extends Component {
    ...
    processRoute( route ) {
        ...
        if ( name ) {
            ...
            return React.createElement( this.props.itemElement, {key: name + Common._generateId(), className: this.props.itemClass}, link );
        }
        return null;
    }
        ...
        routes.map( (route) => {
            ...
            if ( result ) {
                ...
                if (routes[routes.length - 1] !== route) {
                    let separator = React.createElement( this.props.itemElement, {key: Common._generateId(),className: this.props.separatorClass}, this.props.separator );
